					...
					<div class="modal-dialog modal-lg-8">
						<div class="modal-content">
							...
							<div class="modal-body">
								...
								<input type="hidden" name="memory" value="NULL">
								<input type="hidden" name="interface" value="NULL">
								<input type="hidden" name="capacity" value="NULL">
								<label for="cpuname" class="form-label">CPU name</label>
								<input class="form-control" type="text" placeholder="CPU name..." aria-label="default input example" name="name" id="cpuname">

								<label for="select" class="form-label">Supported DDR</label>
					                <select class="form-select" id="select" aria-label="Default select example" name="ddr" required>
									  <option selected>Select a supported DDR</option>
									  <option value="DDR4">DDR4</option>
									  <option value="DDR4">DDR5</option>
									</select>

									<label for="select" class="form-label">CPU Socket</label>
					                <select class="form-select" id="select" aria-label="Default select example" name="socket" required>
									  <option selected>Select a socket type</option>
									  <option value="A">A</option>
									  <option value="B">B</option>
									</select>

									<label for="select" class="form-label">CPU watts</label>
					             <select class="form-select" id="select" aria-label="Default select example" name="watts" required>
					                ...
					                <div class="mb-3">
								  	 <label for="formFileSm" class="form-label">CPU picture</label>
								      <input class="form-control form-control-sm" id="formFileSm" type="file" name="file" required>
								</div>
							</div>
									<div class="modal-footer">
										<button class="btn btn-primary update" name="submit">Upload</button>
...
<section class="recent">
	<div class="dash-cards container-fluid">
        <div class="activity-card">
			<div class="card-single">
			<h3>CPU Table 
                <a href="#" data-bs-toggle="modal" data-bs-target="#gpuModal" class="btn btn-outline-secondary addbtn">Add CPU</a>
				</h3>
                <div class="card-body-table">
					...
					<table id="dataTable">
						...
						<tr>
							...
							<?php
							$query = "SELECT * FROM tools WHERE item_type = 'CPU' ";
